...
/* ========================================================
   CƠ SỞ DỮ LIỆU & GIÁ TIỀN (ĐÃ THÊM TỐC ĐỘ 5-15P)
   ======================================================== */
const db = {
    vi: {
        ...
        txtSpeed: "⚡ Tốc độ: Hoàn thành chỉ sau 5 - 15 phút!",
    ...
    en: {
        ...
        txtSpeed: "⚡ Speed: Completed in just 5 - 15 minutes!",
    ...
    th: {
        ...
        txtSpeed: "⚡ ความเร็ว: เสร็จสิ้นภายใน 5 - 15 นาทีเท่านั้น!",
    ...
    bn: {
        ...
        txtSpeed: "⚡ গতি: মাত্র ৫ - ১৫ মিনিটের মধ্যে সম্পন্ন!",
    ...
    hi: {
        ...
        txtSpeed: "⚡ गति: केवल 5 - 15 मिनट में पूरा!",
    ...
    id: {
        ...
        txtSpeed: "⚡ Kecepatan: Selesai hanya dalam 5 - 15 menit!",
...
function changeLanguage(lang) {
    ...
    setTxt('txtName', data.name); setTxt('txtDesc', data.desc); setTxt('titlePrice', data.titlePrice); setTxt('btnFbText', data.btnFb); setTxt('btnTgText', data.btnTg); setTxt('txtStatsTitle', data.txtStatsTitle); setTxt('txtSpeed', data.txtSpeed);
